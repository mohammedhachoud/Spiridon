...
def format_rgcn_data_for_study(dfs, 
    ...
    # FIXED: Better model saving with error handling
    ...
    # This was causing an error if save_bert_model was False
    # if bert_model and save_bert_model:
    #     del bert_model
    #     gc.collect()
    #     torch.cuda.empty_cache()
...
def prepare_three_level_studies(dfs, 
                                bert_model_name="all-MiniLM-L6-v2", 
                                auto_save=True, 
                                base_output_dir="output/transgnn_data/Bert_ontology",
                                save_bert_model=True, 
                                bert_model_save_dir="models/transgnn_bert"):
    """
